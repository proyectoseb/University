...
jQuery(document).ready(function($) {
	...
	jQuery("[data-placement='top']").tooltip({placement:'top'});
...
jQuery(document).ready(function($) {
	...
	/*var previousCss = $("#myDiv").attr("style"); $("#myDiv") .css({ position: 'absolute',visibility: 'hidden', display: 'block' });
	optionHeight = $("#myDiv").height(); $("#myDiv").attr("style", previousCss ? previousCss : ""); 
	*/
