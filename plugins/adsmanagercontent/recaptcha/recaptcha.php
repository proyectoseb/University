 ...
 * @since       2.5
 */
class plgAdsmanagercontentRecaptcha extends JPlugin
{
	...
	public function onCheckAnswer($code)
	{
		...
		{
			throw new Exception(JText::_('PLG_RECAPTCHA_ERROR_EMPTY_SOLUTION'));
			return false;
		}
		...
		else
		{
			...
			throw new Exception(JText::_('PLG_RECAPTCHA_ERROR_'.strtoupper(str_replace('-', '_', $answers[1]))));
			return false;	
		}
	}
