        ...
        <div class="cpanel-theme">
				...
				<div class="panel-group">
                    ...
                    <div class="panel-theme-color">
						<span data-placement="top" title="Default"     class="theme-color default<?php echo ($templateColor=='default')?' active':'';?>">Default</span>
						...
						<span data-placement="top" title="Carot"  class="theme-color carot<?php echo ($templateColor=='carot')?' active':'';?>">Carot</span>
						<span data-placement="top" title="Violet"  class="theme-color violet<?php echo ($templateColor=='violet')?' active':'';?>">Violet</span>
