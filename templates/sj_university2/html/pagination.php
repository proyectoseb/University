...
function pagination_item_active(&$item) {
    ...
    {
        $display = '<i class="fa fa-long-arrow-right l-hiden"></i> <i class="fa fa-long-arrow-left r-hiden"></i>';
    }
    // Check for "Prev" item
    if ($item->text == JText::_('JPREV'))
    {
        $display = '<i class="fa fa-long-arrow-right r-hiden"> </i> <i class="fa fa-long-arrow-left l-hiden"></i>';
    }
