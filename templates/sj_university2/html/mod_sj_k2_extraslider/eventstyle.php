...
defined('_JEXEC') or die;
  ...
  if(!empty($list)){
	...
	$item_of_page = $params->get('items_page',4);
						...
						<div class="item-wrap-inner">
							...
							<div class="item-image">
							    ...
							    <div class="item-created">
									<span><?php echo  JHTML::_('date', $item->created,JText::_('d')) ;?></span>
									<span><?php echo  JHTML::_('date', $item->created,JText::_('F')) ;?></span>
									<span><?php echo  JHTML::_('date', $item->created,JText::_('Y')) ;?></span>
							    </div>
							    <?php } ?>
							    <?php
							...
							<?php if( ($options->item_desc_display == 1 && !empty($item->displayIntrotext)) || ($item->tags != '') || $options->item_readmore_display == 1 ){?>
								<div class="item-content">
									...
									<div class="item-description">
										...
										<?php $introtext_after= str_replace('...', '',$item->displayIntrotext);
