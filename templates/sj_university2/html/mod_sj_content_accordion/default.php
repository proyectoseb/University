		...
		<div class="acd-items">
			...
			<div class="acd-item">
				<div class="acd-header">
					<?php
					$textcolor= SjContentAccordionHelper::truncate($item->title, $params->get('item_title_max_characters',25));
					$countleng = strlen($str)-1;
					$textcolor1= substr($textcolor, 0 , 1);
					$textcolor2= substr($textcolor, 1 , $countleng);
					?>
					<span><?php echo $textcolor1;?></span><?php echo $textcolor2;?>
				</div>
